...
namespace merkle
{
  ...
  public:
    ...
    /// @brief remove the leaf
    void remove_leaf()
    {
      _leaf.zero();
    }

    /// @brief modify The leaf hash of the path
    void leaf_modify(const HashT<HASH_SIZE> &leaf_in)
    {
      _leaf = leaf_in;
    }
  ...
  public:
    ...
    TreeT(TreeT &&other) : leaf_nodes(std::move(other.leaf_nodes)),
